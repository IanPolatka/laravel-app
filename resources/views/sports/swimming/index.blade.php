    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="home_team_id" id="home_team_id" class="form-control" onChange="window.location.href=this.value">
                            ...
                            @foreach($teams as $team)
                              ...
                              <option value="/swimming/{{$showcurrentyear[0]}}/{{ $team->school_name }}">{{ $team->school_name }}</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="home_team_id"class="form-control" onChange="window.location.href=this.value">
                            ...
                            @foreach($years as $year)
                              ...
                              <option value="/swimming/{{ $year->year }}" @if ($showcurrentyear[0] == $year->year) selected @endif>
                                {{ $year->year }}
                              </option>
                ...
                @if (Auth::user())
                    ...
                    <div class="col-lg-2">
                        ...
                        <p><a class="pull-right btn btn-success" href="/swimming/create">Create Match</a></p>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">{{ $showcurrentyear[0] }} swimming Schedule</div>
                    <ul class="list-group">
                        @foreach($swimming as $item)
                            ...
                            <li class="list-group-item">
                                ...
                                @endif
                                <span class="pull-right"><a href="/swimming/{{ $item->id }}/edit">Edit</a></span>&nbsp;&nbsp;&nbsp;
                            </li>
