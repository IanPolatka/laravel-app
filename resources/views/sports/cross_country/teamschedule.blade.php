            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="home_team_id" id="home_team_id" class="form-control" onChange="window.location.href=this.value">
                            ...
                            @foreach($teams as $team)
                              ...
                              <option value="/cross-country/{{ $selectedyear[0] }}/{{ $team->school_name }}" 
                    ...
                    <div class="form-group">
                        ...
                        <select name="home_team_id"class="form-control" onChange="window.location.href=this.value">
                            ...
                            @foreach($years as $year)
                              ...
                              <option value="/cross-country/{{ $year->year }}" @if ($selectedyear[0] === $year->year) selected @endif>
                                {{ $year->year }}
                              </option>
                ...
                @if (Auth::user())
                    ...
                    <div class="col-lg-2">
                        ...
                        <p><a class="pull-right btn btn-success" href="/cross-country/create">Create Match</a></p>
