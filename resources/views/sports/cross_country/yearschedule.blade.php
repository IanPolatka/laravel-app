    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="home_team_id" id="home_team_id" class="form-control" onChange="window.location.href=this.value">
                            ...
                            @foreach($teams as $team)
                                ...
                                <option value="/cross-country/{{ $year }}/{{ $team->school_name }}" >
                                    {{ $team->school_name }}
                                </option>
                ...
                <div class="col-lg-2">
                    ...
                    <p><a class="pull-right btn btn-success" href="/cross-country/create">Create Game</a></p>
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><strong>Cross Country Schedule</strong></div>
                    <ul class="list-group">
