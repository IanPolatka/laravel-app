    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="home_team_id" id="home_team_id" class="form-control" onChange="window.location.href=this.value">
                            ...
                            @foreach($teams as $team)
                                ...
                                <option value="/wrestling/{{ $year }}/{{ $team->school_name }}" >
                                    {{ $team->school_name }}
                                </option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="home_team_id" class="form-control" onChange="window.location.href=this.value">
                            ...
                            @foreach($years as $year)
                                ...
                                <option value="/wrestling/{{ $year->year }}"  @if ($selectedyearid[0] === $year->id) selected @endif>
                                    {{ $year->year }}
                                </option>
                ...
                <div class="col-lg-2">
                    ...
                    <p><a class="pull-right btn btn-success" href="/wrestling/create">Create Game</a></p>
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><strong>wrestling Schedule</strong></div>
                    <ul class="list-group">
