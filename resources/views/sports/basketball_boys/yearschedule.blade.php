    ...
    <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="home_team_id" id="home_team_id" class="form-control" onChange="window.location.href=this.value">
                            ...
                            @foreach($teams as $team)
                                ...
                                <option value="/basketball-boys/{{ $year }}/{{ $team->school_name }}" >
                                    {{ $team->school_name }}
                                </option>
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><strong>basketball-boys Schedule</strong></div>
                    <ul class="list-group">
                        @forelse ($basketball as $item)
                            ...
                            <li class="list-group-item">
                                ...
                                <a href="/basketball-boys/{{ $selectedyear[0] }}/{{ $item->away_team->school_name }}">
