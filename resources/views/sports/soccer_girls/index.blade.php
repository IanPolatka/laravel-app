    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="home_team_id" id="home_team_id" class="form-control" onChange="window.location.href=this.value">
                            ...
                            @foreach($teams as $team)
                              ...
                              <option value="/soccer-girls/{{$showcurrentyear[0]}}/{{ $team->school_name }}">{{ $team->school_name }}</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="home_team_id"class="form-control" onChange="window.location.href=this.value">
                            ...
                            @foreach($years as $year)
                              ...
                              <option value="/soccer-girls/{{ $year->year }}" @if ($showcurrentyear[0] == $year->year) selected @endif>
                                {{ $year->year }}
                              </option>
                ...
                @if (Auth::user())
                    ...
                    <div class="col-lg-2">
                        ...
                        <p><a class="pull-right btn btn-success" href="/soccer-girls/create">Create Match</a></p>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Girls Soccer Schedule</div>
                    <ul class="list-group">
                        @forelse ($soccer as $item)
                            ...
                            <li class="list-group-item">
                                ...
                                @endif
                                <a href="/soccer-girls/{{ $showcurrentyear[0] }}/{{ $item->away_team->school_name }}">{{ $item->away_team->school_name }}</a> vs
                                ...
                                @endif
                                <a href="/soccer-girls/{{ $showcurrentyear[0] }}/{{ $item->home_team->school_name }}">{{ $item->home_team->school_name }}</a>
                                @if ($item->tournament_title)
                                    <small>({{ $item->tournament_title }})</small>
                                @endif
                                @if (Auth::user())
                                    <span class="pull-right"><a href="/soccer-girls/match/{{ $item->id }}/edit">Edit</a></span>&nbsp;&nbsp;&nbsp;
                                @endif
                            </li>
