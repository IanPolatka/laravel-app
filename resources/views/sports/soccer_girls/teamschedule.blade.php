    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="home_team_id" id="home_team_id" class="form-control" onChange="window.location.href=this.value">
                            ...
                            @foreach($teams as $team)
                                ...
                                <option value="/soccer-girls/{{ $year }}/{{ $team->school_name }}" @if ($selectedteamid[0] === $team->id) selected @endif>
                                    {{ $team->school_name }}
                                </option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="home_team_id"class="form-control" onChange="window.location.href=this.value">
                            ...
                            @foreach($years as $year)
                                ...
                                <option value="/soccer-girls/{{ $year->year }}" @if ($selectedyearid[0] === $year->id) selected @endif>
                                    {{ $year->year }}
                                </option>
                ...
                <div class="col-lg-2">
                    ...
                    <p><a class="pull-right btn btn-success" href="/soccer-girls/create">Create Game</a></p>
        ...
        <div class="col-md-5 col-md-offset-2">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><strong>soccer-girls Schedule</strong></div>
                    <ul class="list-group">
                        @forelse ($soccer as $item)
                            ...
                            <li class="list-group-item">
                                ...
                                @if ($selectedteam[0]['id'] == $item['away_team_id'])
                                    ...
                                    @endif
                                    @ <a href="/soccer-girls/{{ $selectedyear[0] }}/{{ $item->home_team->school_name }}">
                                ...
                                @else
                                    ...
                                    @endif
                                    vs <a href="/soccer-girls/{{ $selectedyear[0] }}/{{ $item->away_team->school_name }}">
                                        {{ $item->away_team->school_name }}
                                    </a>
                                @endif
                                @if (Auth::user())
                                    <span class="pull-right"><a href="/soccer-girls/game/{{ $item->id }}/edit">Edit</a></span>&nbsp;&nbsp;&nbsp;
                                @endif
                            </li>
