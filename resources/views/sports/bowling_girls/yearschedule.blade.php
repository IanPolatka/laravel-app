        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="home_team_id" id="home_team_id" class="form-control" onChange="window.location.href=this.value">
                            ...
                            @foreach($teams as $team)
                                ...
                                <option value="/bowling-girls/{{ $year }}/{{ $team->school_name }}" >
                                    {{ $team->school_name }}
                                </option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="home_team_id" class="form-control" onChange="window.location.href=this.value">
                            ...
                            @foreach($years as $year)
                                ...
                                <option value="/bowling-girls/{{ $year->year }}"  @if ($selectedyearid[0] === $year->id) selected @endif>
                                    {{ $year->year }}
                                </option>
                ...
                <div class="col-lg-2">
                    ...
                    <p><a class="pull-right btn btn-success" href="/bowling-girls/create">Create Game</a></p>
                    ...
                    <ul class="list-group">
                        @forelse ($bowling as $item)
                            ...
                            <li class="list-group-item">
                                ...
                                <a href="/bowling-girls/{{ $selectedyear[0] }}/{{ $item->away_team->school_name }}">
                                    {{ $item->away_team->school_name }}
                                </a>
                                vs 
                                <a href="/bowling-girls/{{ $selectedyear[0] }}/{{ $item->home_team->school_name }}">
                                ...
                                @endif
                                @if (Auth::user())
                                    <span class="pull-right"><a href="/bowling-girls/match/{{ $item->id }}/edit">Edit</a></span>&nbsp;&nbsp;
                                @endif
