                    ...
                    <form method="POST" action="/tennis">
                      ...
                      {{ csrf_field() }}
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="boys_match_score" name="boys_match_score">
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="girls_match_score" name="girls_match_score">
                        </div>
